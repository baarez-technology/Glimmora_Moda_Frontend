            ...
            <div className="grid lg:grid-cols-3 gap-12 lg:gap-16">
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-32 bg-charcoal-deep p-8">
                  ...
                  {isHydrated && !isAuthenticated && (
                    <div className="mt-6 p-4 border border-gold-soft/30 bg-gold-soft/5">
                      <p className="text-xs text-taupe text-center">
                        Sign in to track your orders, access your Fashion Passport, and enjoy personalized recommendations.
                      </p>
                    </div>
                  )}
