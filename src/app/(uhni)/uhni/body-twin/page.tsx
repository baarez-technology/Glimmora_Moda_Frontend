    ...
    <div className="space-y-6">
      ...
      {hasMeasurements && (
        <div className="bg-white border border-sand/50 p-8">
          ...
          <div className="space-y-6">
            <div>
              <p className="text-[10px] tracking-[0.2em] uppercase text-stone mb-3">Core</p>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={item.label} className="p-5 bg-parchment border border-sand/50">
                    ...
                    <p className="font-display text-xl text-charcoal-deep">{item.value} <span className="text-sm text-taupe font-normal">{item.unit}</span></p>
                  </div>
                ))}
              </div>
            </div>
            {[m.weight, m.shoulderWidth, m.sleeveLength, m.neck, m.thigh, m.footLength].some(v => v != null) && (
              <div>
                <p className="text-[10px] tracking-[0.2em] uppercase text-stone mb-3">Detailed</p>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[
            ...
            <div className="bg-white border border-sand/50 p-8 mb-8">
              ...
              {activeStep === 3 && (
                <div>
                  ...
                  {/* Core measurements */}
                  <p className="text-[10px] tracking-[0.3em] uppercase text-stone mb-4">Core</p>
                  ...
                  <p className="text-[10px] tracking-[0.3em] uppercase text-stone mb-4">Detailed</p>
