  ...
  if (isLoading) {
    return (
      <div className="p-8 text-center">
        <p className="text-stone">Loading boutique performance data...</p>
      </div>
    );
  }
    ...
    <div>
      ...
      <div className="mb-8 p-8 pb-0">
        <div className="flex items-center gap-2 text-sm text-stone mb-4">
          ...
          <ChevronRight size={14} />
          <span className="text-charcoal-deep">Boutiques</span>
        </div>
        <h1 className="font-display text-3xl text-charcoal-deep">Boutique Performance Index</h1>
        <p className="text-stone mt-2">Track and compare performance across all boutique locations</p>
      </div>
