    ...
    <div>
      ...
      <div className="mb-8 p-8 pb-0">
        <div className="flex items-center gap-2 text-sm text-stone mb-4">
          ...
          <Link href="/brand/intelligence/memory" className="hover:text-charcoal-deep transition-colors">Intelligence</Link>
          <ChevronRight size={14} />
          <span className="text-charcoal-deep">Memory Imprint</span>
        </div>
        <h1 className="font-display text-3xl text-charcoal-deep">Memory Imprint</h1>
        <p className="text-stone mt-2">Measure how deeply your brand touchpoints resonate in customer memory.</p>
      </div>
