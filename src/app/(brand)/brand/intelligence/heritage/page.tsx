...
import { ChevronRight, Archive, Clock } from 'lucide-react';
  ...
  if (isLoading) {
    return (
      <div className="p-8 text-center">
        <p className="text-stone">Loading heritage asset data...</p>
      </div>
    );
  }
    ...
    <div>
      ...
      <div className="mb-8 p-8 pb-0">
        <div className="flex items-center gap-2 text-sm text-stone mb-4">
          ...
          <ChevronRight size={14} />
          <span className="text-charcoal-deep">Heritage</span>
        </div>
        <h1 className="font-display text-3xl text-charcoal-deep">Heritage Preservation AI</h1>
        <p className="text-stone mt-2">Catalog, preserve, and digitize brand heritage assets with AI assistance</p>
      </div>
