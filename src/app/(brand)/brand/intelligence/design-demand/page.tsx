    ...
    <div>
      ...
      <div className="mb-8 p-8 pb-0">
        <div className="flex items-center gap-2 text-sm text-stone mb-4">
          ...
          <Link href="/brand/intelligence/design-demand" className="hover:text-charcoal-deep transition-colors">Intelligence</Link>
          <ChevronRight size={14} />
          <span className="text-charcoal-deep">Design-to-Demand</span>
        </div>
        <h1 className="font-display text-3xl text-charcoal-deep">Design-to-Demand Simulation</h1>
        <p className="text-stone mt-2">Simulate market demand before production to optimize sell-before-make strategies.</p>
      </div>
