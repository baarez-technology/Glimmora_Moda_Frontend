...
import { ChevronRight, Rocket, Calendar } from 'lucide-react';
  ...
  if (isLoading) {
    return (
      <div className="p-8 text-center">
        <p className="text-stone">Loading drop simulation data...</p>
      </div>
    );
  }
    ...
    <div>
      ...
      <div className="mb-8 p-8 pb-0">
        <div className="flex items-center gap-2 text-sm text-stone mb-4">
          ...
          <ChevronRight size={14} />
          <span className="text-charcoal-deep">Drop Simulator</span>
        </div>
        <h1 className="font-display text-3xl text-charcoal-deep">Global Drop Strategy Simulator</h1>
        <p className="text-stone mt-2">Simulate and optimize product drop strategies across global markets</p>
      </div>
