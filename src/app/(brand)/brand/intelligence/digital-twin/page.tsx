...
export default function DigitalTwinPage() {
  ...
  const totalNodes = twin.nodes.length;
    ...
    <div>
      ...
      <div className="mb-8 p-8 pb-0">
        <div className="flex items-center gap-2 text-sm text-stone mb-4">
          ...
          <Link href="/brand/intelligence/digital-twin" className="hover:text-charcoal-deep transition-colors">Intelligence</Link>
          <ChevronRight size={14} />
          <span className="text-charcoal-deep">Digital Twin</span>
        </div>
        <h1 className="font-display text-3xl text-charcoal-deep">Brand Digital Twin</h1>
        <p className="text-stone mt-2">A living digital replica of your brand&apos;s identity, connections, and market position.</p>
      </div>
