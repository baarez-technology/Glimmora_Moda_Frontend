...
import { Wind, Layers, Scale, Thermometer, Droplets, Sparkles } from 'lucide-react';
    ...
    <div className={`bg-white rounded-xl border border-stone/20 overflow-hidden ${className}`}>
      ...
      <div className="px-5 py-4 border-b border-stone/10 bg-gradient-to-r from-ivory-cream to-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-medium text-charcoal-deep">Fabric Intelligence</h3>
            <p className="text-xs text-stone/70">IV™ Material Simulation</p>
          </div>
        </div>
      </div>
