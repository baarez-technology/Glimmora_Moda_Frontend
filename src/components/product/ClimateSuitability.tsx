...
import { Thermometer, Droplets, Sun, Wind, Snowflake, CloudRain, Cloud, Home, TreePine, Activity } from 'lucide-react';
...
export default function ClimateSuitability({
  ...
  return (
    <div className={`bg-white rounded-xl border border-stone/20 overflow-hidden ${className}`}>
      {/* Header */}
      <div className="px-5 py-4 border-b border-stone/10 bg-gradient-to-r from-sky-50 to-white">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-sky-100 rounded-full flex items-center justify-center">
            <Thermometer className="w-5 h-5 text-sky-600" />
          </div>
          <div>
            <h3 className="font-medium text-charcoal-deep">Climate Suitability</h3>
            <p className="text-xs text-stone/70">Weather performance analysis</p>
          </div>
