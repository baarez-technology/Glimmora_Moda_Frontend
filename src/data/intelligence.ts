...
export const heritageEvents: HeritageEvent[] = [
  ...
  { id: 'gucci-1953', brandId: 'gucci', year: 1953, title: 'Horsebit Loafer', description: 'The iconic Horsebit loafer is introduced, referencing equestrian heritage.', longDescription: 'The distinctive metal horsebit hardware became one of Gucci\'s most recognizable signatures, connecting modern luxury to the brand\'s equestrian roots.', image: 'https://images.unsplash.com/photo-1614252369475-531eba835eb1?w=800', significance: 'innovation', relatedProducts: ['horsebit-loafer'] },
  { id: 'gucci-1961', brandId: 'gucci', year: 1961, title: 'Jackie Bag Named', description: 'The hobo bag becomes known as the Jackie after Jacqueline Kennedy Onassis.', longDescription: 'Jacqueline Kennedy Onassis was frequently photographed carrying this curved hobo bag, and by the 1970s it was officially renamed in her honor.', image: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=800', significance: 'cultural', relatedProducts: ['jackie-1961'] },
  ...
  { id: 'hermes-1937', brandId: 'hermes', year: 1937, title: 'First Silk Scarf', description: 'Hermès introduces the first silk carré, "Jeu des Omnibus et Dames Blanches."', longDescription: 'The launch of the silk scarf marked Hermès\' expansion beyond leather goods. Each design takes up to two years to develop and requires up to 45 screens to print.', significance: 'innovation', relatedProducts: ['carre-silk-scarf'] },
...
export const culturalJourneys: CulturalJourney[] = [
  {
    ...
    stops: [
      { id: 'art-1', order: 1, title: 'The Museum Connection', content: 'Fashion has long sought legitimacy in the halls of great museums. The Costume Institute at the Metropolitan Museum of Art has hosted exhibitions featuring Dior, Chanel, and Alexander McQueen, drawing millions of visitors and blurring the line between fashion and fine art.', mediaUrl: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800', mediaType: 'image', relatedBrands: ['dior'], relatedProducts: ['bar-jacket'], relatedStories: ['lady-dior-story'] },
      ...
      { id: 'art-3', order: 3, title: 'Craftsmanship as Art', content: 'The métiers d\'art—featherwork, embroidery, pleating—represent fashion\'s living art heritage. These artisanal techniques, often taking decades to master, transform fabric into sculptural masterpieces.', mediaUrl: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800', mediaType: 'image', relatedBrands: ['hermes'], relatedProducts: ['birkin-30'], relatedStories: ['hermes-craftsmanship'] },
    ]
  },
  {
    id: 'journey-travel',
